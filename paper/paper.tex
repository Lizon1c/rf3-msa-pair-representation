...
\author{Author One$^{1}$, Author Two$^{1}$, Author Three$^{1,\ast}$\\
\small $^{1}$Affiliation withheld for review\\
\small $^{\ast}$Corresponding author: \texttt{corresponding@example.org}}
...
ledger accompanying this manuscript are available in the project repository
(\texttt{msa\_role\_properties/}); embeddings will be deposited on request /
upon publication.
